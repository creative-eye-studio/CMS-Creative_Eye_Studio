...
require __DIR__.'/ContainerB4n4Ezk/App_KernelDevDebugContainer.php';
require __DIR__.'/ContainerB4n4Ezk/EntityManager_9a5be93.php';
require __DIR__.'/ContainerB4n4Ezk/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerB4n4Ezk/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerB4n4Ezk/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerB4n4Ezk/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerB4n4Ezk/getValidator_ExpressionService.php';
require __DIR__.'/ContainerB4n4Ezk/getValidator_EmailService.php';
require __DIR__.'/ContainerB4n4Ezk/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerB4n4Ezk/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerB4n4Ezk/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerB4n4Ezk/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerB4n4Ezk/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerB4n4Ezk/getSession_Storage_NativeService.php';
require __DIR__.'/ContainerB4n4Ezk/getSessionService.php';
require __DIR__.'/ContainerB4n4Ezk/getServicesResetterService.php';
require __DIR__.'/ContainerB4n4Ezk/getSerializer_Mapping_CacheClassMetadataFactoryService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_PasswordEncoderService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_EncoderFactory_GenericService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_ContextListener_0Service.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Authentication_Provider_Guard_MainService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Authentication_Listener_Guard_MainService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Authentication_Listener_Anonymous_MainService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_Authentication_GuardHandlerService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_AccessMapService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecrets_VaultService.php';
require __DIR__.'/ContainerB4n4Ezk/getRouting_LoaderService.php';
require __DIR__.'/ContainerB4n4Ezk/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerB4n4Ezk/getMonolog_Logger_SecurityService.php';
require __DIR__.'/ContainerB4n4Ezk/getMimeTypesService.php';
require __DIR__.'/ContainerB4n4Ezk/getMailer_TransportFactory_SmtpService.php';
require __DIR__.'/ContainerB4n4Ezk/getMailer_TransportFactory_SendmailService.php';
require __DIR__.'/ContainerB4n4Ezk/getMailer_TransportFactory_NullService.php';
require __DIR__.'/ContainerB4n4Ezk/getMailer_TransportFactory_NativeService.php';
require __DIR__.'/ContainerB4n4Ezk/getMailer_TransportFactory_GmailService.php';
require __DIR__.'/ContainerB4n4Ezk/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerB4n4Ezk/getFosCkEditor_Form_TypeService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_Type_FormService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_Type_EntityService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_Type_ColorService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_ServerParamsService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_RegistryService.php';
require __DIR__.'/ContainerB4n4Ezk/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerB4n4Ezk/getFmElfinder_LoaderService.php';
require __DIR__.'/ContainerB4n4Ezk/getFmElfinder_Form_TypeService.php';
require __DIR__.'/ContainerB4n4Ezk/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerB4n4Ezk/getErrorControllerService.php';
require __DIR__.'/ContainerB4n4Ezk/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerB4n4Ezk/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerB4n4Ezk/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/ContainerB4n4Ezk/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerB4n4Ezk/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerB4n4Ezk/getDoctrine_Migrations_ContainerAwareMigrationsFactoryService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerB4n4Ezk/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerB4n4Ezk/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerB4n4Ezk/getContainer_GetenvService.php';
require __DIR__.'/ContainerB4n4Ezk/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerB4n4Ezk/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerB4n4Ezk/getCache_SystemClearerService.php';
require __DIR__.'/ContainerB4n4Ezk/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerB4n4Ezk/getCache_AppClearerService.php';
require __DIR__.'/ContainerB4n4Ezk/getTemplateControllerService.php';
require __DIR__.'/ContainerB4n4Ezk/getRedirectControllerService.php';
require __DIR__.'/ContainerB4n4Ezk/getElFinderControllerService.php';
require __DIR__.'/ContainerB4n4Ezk/getUsersAuthenticatorService.php';
require __DIR__.'/ContainerB4n4Ezk/getUsersRepositoryService.php';
require __DIR__.'/ContainerB4n4Ezk/getPagesRepositoryService.php';
require __DIR__.'/ContainerB4n4Ezk/getArticlesRepositoryService.php';
require __DIR__.'/ContainerB4n4Ezk/getRegistrationFormTypeService.php';
require __DIR__.'/ContainerB4n4Ezk/getCodeFrontFormTypeService.php';
require __DIR__.'/ContainerB4n4Ezk/getAddPagesTypeService.php';
require __DIR__.'/ContainerB4n4Ezk/getAddArticleTypeService.php';
require __DIR__.'/ContainerB4n4Ezk/getSecurityControllerService.php';
require __DIR__.'/ContainerB4n4Ezk/getRegistrationControllerService.php';
require __DIR__.'/ContainerB4n4Ezk/getAdminControllerService.php';
require __DIR__.'/ContainerB4n4Ezk/get_ServiceLocator_WSTQLB9Service.php';
require __DIR__.'/ContainerB4n4Ezk/get_ServiceLocator_ITWUpOYService.php';
require __DIR__.'/ContainerB4n4Ezk/get_ServiceLocator_UDgw6OlService.php';
require __DIR__.'/ContainerB4n4Ezk/get_ServiceLocator_KfwZsneService.php';
require __DIR__.'/ContainerB4n4Ezk/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/ContainerB4n4Ezk/get_ServiceLocator_5nX7ca3Service.php';
require __DIR__.'/ContainerB4n4Ezk/get_ServiceLocator_2oQQn1fService.php';
require __DIR__.'/ContainerB4n4Ezk/get_Container_Private_SerializerService.php';
require __DIR__.'/ContainerB4n4Ezk/get_Container_Private_Security_Csrf_TokenManagerService.php';
require __DIR__.'/ContainerB4n4Ezk/get_Container_Private_Form_Type_FileService.php';
require __DIR__.'/ContainerB4n4Ezk/get_Container_Private_Form_FactoryService.php';
require __DIR__.'/ContainerB4n4Ezk/get_Container_Private_FilesystemService.php';
require __DIR__.'/ContainerB4n4Ezk/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Form\CodeFrontFormType';
